...
\item
Next, select the Method Data Sources tab. The Method Data Sources tab allows us to create data sources that will call methods on agents in our model. For the Source Class select UserObserver. Click Add to add an entry . Left click in the Method column of the added entry and choose \emph{timestamp} from the drop down list.
...
\item Under Groovy:
	...
	\end{itemize}
\item Under Groovy $\rightarrow$ Editor:
	\begin{itemize}
	\item Uncheck: Enable semantic highlighting ...
	\end{itemize}
