...
In addition, by default autobuilding is disabled. However, this is not appropriate for projects written in Java. To enable auto building go to the Project menu and select Build Automatically.
...
\item Next, click in the ÒcontentÓ column for the id attribute and type ÒgridÓ (no quotes).
\end{enumerate}
\vspace{.2in}
