...
Another agent behavior scheduling scenario is nested scheduling of activities. This corresponds to, for example, weekly vs monthly activities. Figure~\ref{fig:weekMonthExample} shows a simple example of how you might define a statechart that does this.
