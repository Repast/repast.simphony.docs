...
In addition, statecharts can be directly manipulated via mouse clicks, thereby permitting manual activation of inactive states and the forcing of transitions to be followed. This feature allows for experimentation with alternative or rare event paths through agent statecharts. Right click on a state to pop-up the menu to activate it, or right click on a transition to pop-up the menu to follow it.
